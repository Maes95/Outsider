...
roles de los jugadores, se les indica una pista/contraseña\tutor{Para los jugadores Inocentes, es la palabra a adivinar por el outsider. Pista/contraseña suena extraño} a los jugadores Inocentes y se procede con la lógica
de juego estándar:\tutor{Después de dos puntos, va minúsculas. He corregido un par, pero a partir de aquí, corrigelas tu} Cada jugador siguiendo un orden secuencial, escribirá una palabra relacionada con su contraseña
...
Cuando existen más de tres jugadores en una partida, se ve\tutor{Es ``se ve'', es poco formal. mejor ``se detecta la necesidad de ...''} bastante necesario el poder jugar varias rondas con otras contraseñas,
...
igual al de Outsiders\tutor{Aún no has introducido que puede haber más, clarifica al menos que, de momento, solo hay 1} o se elimine mediante votación al Outsider en cuestión.

\subsection{Varios Outsider}

Relacionado con el anterior punto, en partidas con varios jugadores se ve\tutor{lo mismo} necesario aumentar el número de Outsiders en aras de
...
Se propone de forma adicional trabajar ciertos elementos de CI\tutor{La primera vez que hablas de un término, no puede ser usando sus siglas. Usa: Integración Continua (CI, por sus siglas en inglés)}, especialmente el testing del software, ya que, es una práctica
...
Para finalizar con la descripción inicial de objetivos/requisitos\tutor{Mejor déjalo sólo en objetivos, que esta sección se te ha alargado mucho y parecen casi requisitos}, se querría tener en cuenta una pequeña prueba con usuarios a mitad de
