...
Las empresas y organizaciones buscan desarrolladores software altamente capacitados, pero también especializados en materias en concreto. Desde mi punto de vista,\tutor{Esto es opinión y el TFG no es para opinar. Trata de reformular esta frasse o simplemente eliminala.}
...
de datos en lo que a priori se presenta como una sencilla aplicación. Todo el trabajo entre bambalinas\tutor{otra vez un término que no es formal.} es muy poco conocido y suele tener gran importancia. En este trabajo en particular,
